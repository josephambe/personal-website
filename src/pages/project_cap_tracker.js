...
import bg from '../assets/images/projects/cap_tracker/team.jpg'
import pic04 from '../assets/images/projects/cap_tracker/team.jpg'

class Project_cap_tracker extends React.Component {
      ...
      <Layout>
        ...
        <div className="major">
          <div className="article">
            <h1>Building A Cap Tracking App</h1>
            <h2>The Summmary:</h2>
...
export default Project_cap_tracker
